...
<head>
    ...
    <link rel="stylesheet" href="styles/tutoradohome/tutor.css">
</head>
<body>
    ...
    <div id="container">
        ...
        <div id="navbar">
            <div id="navbar-logo">
                <div><img src="imagens/tutoradohome/Frame 1.png" id="navbar-image" alt="frame.png"></div>
                <div id="navbar-name"><p>Tutoria</p><p>De</p><p>Pares</p></div>
            </div>
                <div id="navbar-inicio">
                    <img  id="navbar-image2" src="imagens/tutoradohome/icons8-soma-96.png" alt="icons8-soma-384.png">
                    <img class="iniciar-barra" id="navbar-image3" src="imagens/tutoradohome/icons8-usuario-96.png" alt="">
                    <h2 class="iniciar-barra2" id="navbar-name2"><%= ((Tutorado) request.getAttribute("tutorado")).getNome().split(" ")[0] %></h2>
                </div>
        </div>
