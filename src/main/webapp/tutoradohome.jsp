    ...
    <div id="container">
        <div id="shadow-entrar-tutoria" class="blur-in">
            <div id="div-entrar-tutoria">
                ...
                <div id="painel-entrar-tutoria">
                    ...
                    <div>
                        <form action="loginTutoriaTutorado" id="form-entrar-tutoria" name="form-entrar-tutoria">
        ...
        <div id="barra-ferramentas"  class="blur-in">
            ...
            <div id="nav-zone">
                ...
                <div id="nav-lateral-option1"> <a href="edicaoTutorado?id=<%= request.getParameter("id")%>"> Editar Perfil </a> </div>
                        ...
                        if (tutorias.size() == 0) { %>
                           ...
                           <% } else { %>
                               ...
                               <% for (int i = 1; i < tutorias.size(); i++) { %>
                                   <a href="entrarTutoriaTutorado?codigo=<%= tutorias.get(i).getCodigo() %>&id=<%= request.getParameter("id") %>">
