...
<body>
    ...
    <div id="corpo-criar-meta">
        <form class="editar-meta" action="criarMetaNapne" id="criarMeta">
    ...
    <div id="corpo-deletar-meta" class="corpo-deletar-meta">
        ...
        <div id="navbar">
            <div id="navbar-logo">
                <div><a href="voltarParaMainNapne?id=<%= request.getParameter("id")%>"><img src="imagens/metas/Frame 1.png" id="navbar-image" class="tracking-in-expand-forward-top" alt="frame.png"></div>
                <div id="navbar-name" class="tracking-in-expand-forward-top"><p>Tutoria</p><p>De</p><p>Pares</p></div>
            </div>
                <div id="navbar-inicio">
                    <a href="napnehome?id=<%= request.getAttribute("id") %>" style="margin-top: 3.4%;"><img  id="navbar-image2" class="tracking-in-expand-forward-top" src="imagens/metas/icons8-voltar-67.png" alt="icons8-casa-384.png"></a>
