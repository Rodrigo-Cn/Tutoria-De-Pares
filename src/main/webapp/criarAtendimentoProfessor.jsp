...
<head>
    ...
    <link rel="stylesheet" href="styles/criarAtendimento/criarAtendimento.css">
    ...
    <div id="navbar">
        <div id="navbar-logo">
         ...
         <div id="navbar-inicio">
              <a href="voltarParaMainProfessor?id=<%= request.getParameter("id")%>" style="margin-top: 3.4%;"><img  id="navbar-image2" class="tracking-in-expand-forward-top" src="imagens/cadastrarNapne/icons8-voltar-67.png" alt="icons8-casa-384.png"></a>
      ...
      <div id="container-main">
        <div id="container-conteudo">
                <form action="criarAtendimentoProfessor?codigo=<%= request.getAttribute("codigo") %>">
                                    ...
                                    <div class="half">
                                        ...
                                        <div class="form-grupo">
                                            <input class="form-input" type="number" name="cargaHoraria" placeholder="Carga horária" required>
                                            <i class="fa-solid fa-clock icones"></i>
                                        </div>

                                        <div class="form-grupo" id="senha">
                                            <input class="form-input" type="time" name="horario" required>
                                       </div>
                                    ...
                                    <div class="half">
                                        <div class="form-grupo" id="disciplina">
                                            <input class="form-input" type="text" name="local" placeholder="Local" required>
                                            <i class="fa-solid fa-location-dot icones"></i>
                                        </div>

                                        <div class="form-grupo">
                                            <input class="form-input" type="text" name="conteudoTratado" placeholder="Conteúdo tratado" required>
                                            <i class="fa-solid fa-book icones"></i>
                                        </div>

                                       <input class="form-input" type="text" name="codigo" style="visibility: hidden; display:none" value="<%= request.getParameter("codigo") %>">
