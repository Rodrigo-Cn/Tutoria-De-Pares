...
<body>
    ...
    <div id="body-editar-mensagem" style="display: flex;">
        <form id="editar-mensagem" action="editarMensagemNapne" onsubmit="return validarFormulario()">
            <div id="editar-mensagem-title">
                <div style="width: 90%;">
                    <h2 style="margin-left: 34%;">Editar Mensagem</h2>
                </div><a href="carregarMensagensNapne?codigoMeta=<%=((Meta) request.getAttribute("meta")).getCodigo()%>&codigoTutoria=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>&id=<%= ((RepresentanteNapne) request.getAttribute("representante")).getId() %>"><img src="imagens/mensagens/icons8-fechar-janela-48.png" alt=""></a>
            </div>
                    ...
                    <div class="card">
                         <div class="title-card">
                              ...
                              <div class="title-card-options">
                                   ...
                                   <a href=""><img src="imagens/mensagens/icons8-lixo-50.png" alt=""></a>
                              </div>
                         </div>
                         <div class="body-card">
