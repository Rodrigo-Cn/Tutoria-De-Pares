...
<body>
        <div id="navbar">
            <div id="navbar-logo">
                ...
                <div id="navbar-inicio"> 
                    <a href="tutorhome?id=<%= ((Tutor) request.getAttribute("tutor")).getId() %>" style="margin-top: 3.4%;"><img  id="navbar-image2" class="tracking-in-expand-forward-top" src="imagens/tutoriaGenerico/icons8-voltar-67.png" alt="icons8-casa-384.png"></a>
        ...
        <div id="section">
            ...
            <div id="section-dados">
                ...
                <div id="section-buttons"><a href="carregarMetasTutor?id=<%=((Tutor) request.getAttribute("tutor")).getId()%>&codigo=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>"><input class="buttons" type="button" value="Metas"></a><a href="carregarAtendimentosTutor?id=<%=((Tutor) request.getAttribute("tutor")).getId()%>&codigo=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>"><input class="buttons" type="button" value="Atendimentos"></a></div>
            </div>
        </div>
