...
<script>
    ...
    <div id="body-editar-mensagem" style="display: flex;">
        <form id="editar-mensagem" action="editarMensagemProfessor" onsubmit="return validarFormulario()">
            <div id="editar-mensagem-title">
                <div style="width: 90%;">
                    <h2 style="margin-left: 34%;">Editar Mensagem</h2>
                </div><a href="carregarMensagensProfessor?codigoMeta=<%=((Meta) request.getAttribute("meta")).getCodigo()%>&codigoTutoria=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>&id=<%= ((Professor) request.getAttribute("professor")).getId() %>"><img src="imagens/mensagens/icons8-fechar-janela-48.png" alt=""></a>
            </div>
