   ...
   <div id="corpo-deletar-meta" class="corpo-deletar-meta">
        ...
        <div id="navbar">
            <div id="navbar-logo">
                ...
                <div id="navbar-inicio">
                    <a href="entrarTutoriaProfessor?codigo=<%= request.getAttribute("codigo") %>" style="margin-top: 3.4%;"><img id="navbar-image2" class="tracking-in-expand-forward-top" src="imagens/atendimentoAdm/icons8-voltar-67.png" alt="icons8-casa-384.png"></a>
        ...
        <div id="section">
            ...
            <div id="options-section">
                <a href="irCriarAtendimentoProfessor?codigo=<%=request.getAttribute("codigo")%>" id="a"><img id="options-section-criar" src="imagens/atendimentoAdm/icons8-mais-100.png" alt=""></a>
                <% if (atendimentos.size() > 0) { %>
                    <a id="b" href="gerarRelatorioFinalProfessor?codigo=<%= request.getAttribute("codigo") %>"><input  id="options-section-button" type="button" value="Relatório Final"></a>
                <% } else{ %>
            ...
            <% } else { %>
                ...
                <div class="card">
                    <div class="card-title">
                        ...
                        <div class="card-title2"><a href="gerarRelatorioUnitarioProfessor?id=<%= atendimentos.get(i).getId() %>" target="_blank"><img src="imagens/atendimentoAdm/icons8-relatório-100.png" alt="icons8-relatório-100.png"></a><a href="editandoAtendimentoProfessor?codigo=<%= atendimentos.get(i).getId() %>"><img src="imagens/atendimentoAdm/icons8-configuração-100.png" alt=""></a><a onclick="confirmar(<%= request.getAttribute("codigo") %>, <%= atendimentos.get(i).getId()%>)"><img src="imagens/atendimentoAdm/icons8-lixo-100.png" alt=""></a></div>
                    </div>
                    <div class="card-section">
...
<script src="scripts/atendimento/deletarAtendimentoProfessor.js"></script>
