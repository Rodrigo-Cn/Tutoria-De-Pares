    ...
    new window.VLibras.Widget('https://vlibras.gov.br/app');
        ...
        <div id="section">
            ...
            <div id="section-dados">
                ...
                <div id="section-buttons"><a href="carregarMetasTutorado?id=<%=((Tutorado) request.getAttribute("tutorado")).getId()%>&codigo=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>"><input class="buttons" type="button" value="Metas"></a><a href="carregarAtendimentosTutorado?id=<%=((Tutorado) request.getAttribute("tutorado")).getId()%>&codigo=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>"><input class="buttons" type="button" value="Atendimentos"></a></div>
            </div>
        </div>
