...
<body>
        ...
        <div id="section-codigo-senha"><div id="section-codigo">Código: <%= ((Tutoria) request.getAttribute("tutoria")).getCodigo() %></div><div id="section-senha">Senha: <%= ((Tutoria) request.getAttribute("tutoria")).getSenha() %></div></div>
                ...
                <div id="section-buttons"><a href="carregarMetasNapne?id=<%=((RepresentanteNapne) request.getAttribute("representante")).getId()%>&codigo=<%=((Tutoria) request.getAttribute("tutoria")).getCodigo()%>"><input class="buttons" type="button" value="Metas"></a><a href=""><input class="buttons" type="button" value="Atendimentos"></a></div>
            </div>
        </div>
